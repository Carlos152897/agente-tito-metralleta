...
#
# Lo lanza launchd cada 15 min (ver com.visionarytrades.watchlist-sync.plist). También se puede
...
PROMPT="Eres el drenador del watchlist de Visionary Trades. Empuja estos contratos al watchlist de
